...
import org.repositoryminer.ast.AbstractAnnotation;
import org.repositoryminer.ast.AbstractClass;
import org.repositoryminer.ast.AbstractEnum;
import org.repositoryminer.ast.AbstractImport;
...
public class FileVisitor extends ASTVisitor {
	...
	public boolean visit(ImportDeclaration node) {
		imports.add(new AbstractImport(node.getName().getFullyQualifiedName(), node.isStatic(), node.isOnDemand()));
		return true;
	}
