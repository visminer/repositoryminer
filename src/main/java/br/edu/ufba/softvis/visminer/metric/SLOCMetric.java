...
@MetricAnnotation(
    ...
    description = "Source lines of code (SLOC), also known as lines of code (LOC), is a "
        + "software metric used to measure the size of a computer program by counting the number of"
