...
public class VisMiner {
   ...
   * @param repository
   * @param metrics
   * Analyzes and persists repository information in database and defines what metrics will be
   * calculated for each repository state. Set "metrics" as null if you don't want to calculate any
   *  metric.
   * @throws IOException 
   */
   ...
   * @param metrics
   * Analyzes and persists new repository informations in database and defines what metrics will be
   *  calculated only for new repository states. Set "metrics" as null if you don't want to 
